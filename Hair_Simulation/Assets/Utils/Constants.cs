...
public class Constants
{
    ...
    public static readonly float HairMass = 0.01f;
    ...
    public static readonly float HairStiffness = 0.99f; // Stretch resistance
    public static readonly float HairDamping = 0.3f; // Dampens movement
