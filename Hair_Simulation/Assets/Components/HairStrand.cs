...
public class HairStrand : MonoBehaviour
{
    ...
    {
        StrandVertex vertex0 = new StrandVertex(new Vector3(0, 6f, 0), Constants.StraightHairMass, true); this.Vertices.Add(vertex0);
        StrandVertex vertex1 = new StrandVertex(new Vector3(0, 5.4f, 0), Constants.StraightHairMass); this.Vertices.Add(vertex1);
        StrandVertex vertex2 = new StrandVertex(new Vector3(0, 4.8f, 0), Constants.StraightHairMass); this.Vertices.Add(vertex2);
        StrandVertex vertex3 = new StrandVertex(new Vector3(0, 4.2f, 0), Constants.StraightHairMass); this.Vertices.Add(vertex3);
        StrandVertex vertex4 = new StrandVertex(new Vector3(0, 3.6f, 0), Constants.StraightHairMass); this.Vertices.Add(vertex4);
        StrandVertex vertex5 = new StrandVertex(new Vector3(0, 3.0f, 0), Constants.StraightHairMass); this.Vertices.Add(vertex5);
        StrandVertex vertex6 = new StrandVertex(new Vector3(0, 2.4f, 0), Constants.StraightHairMass); this.Vertices.Add(vertex6);
        StrandVertex vertex7 = new StrandVertex(new Vector3(0, 1.8f, 0), Constants.StraightHairMass); this.Vertices.Add(vertex7);
        StrandVertex vertex8 = new StrandVertex(new Vector3(0, 1.2f, 0), Constants.StraightHairMass); this.Vertices.Add(vertex8);
        StrandVertex vertex9 = new StrandVertex(new Vector3(0, 0.6f, 0), Constants.StraightHairMass); this.Vertices.Add(vertex9);
        StrandVertex vertex10 = new StrandVertex(new Vector3(0, 0f, 0), Constants.StraightHairMass); this.Vertices.Add(vertex10);
    }
    ...
    void SimulateStrand()
    {
        ...
        foreach (var spring in this.Springs)
        {
            ...
            float springForceMagnitude = Constants.StraightHairStiffness * (currentLength - spring.Length);
            Vector3 springForce = springForceMagnitude * direction;

            Vector3 relativeVelocity = vertexTo.Velocity - vertexFrom.Velocity;
            Vector3 dampingForce = Constants.StraightHairDamping * relativeVelocity;
