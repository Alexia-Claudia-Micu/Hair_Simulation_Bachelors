...
public class HairStrand : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        StrandVertex vertex1 = new StrandVertex(new Vector3(0.2f,4,0.1f), new Vector3(0,0,0), 1.0f); this.Vertices.Add(vertex1);
        StrandVertex vertex2 = new StrandVertex(new Vector3(0.2f,3.4f,0), new Vector3(0,0,0), 1.0f); this.Vertices.Add(vertex2);
        StrandVertex vertex3 = new StrandVertex(new Vector3(0.3f,3,0), new Vector3(0,0,0), 1.0f); this.Vertices.Add(vertex3);
